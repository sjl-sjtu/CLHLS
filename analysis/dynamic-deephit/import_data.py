# -*- coding: utf-8 -*-
"""
Created on Sat Nov 13 17:11:56 2021

@author: 10237
"""

import os
os.chdir("C:\\Users\\DELL\\OneDrive\\newclhls")
# os.chdir("F:\\OneDrive\\newclhls")
import pandas as pd
import numpy as np
...
def import_dataset(norm_mode = 'standard'):
    ...
    #df_                = pd.read_csv("dflongi.csv")
    #df_                = pd.read_csv("dflongi_del.csv")
    #df_                = pd.read_csv("dflongi_imp.csv")
    #df_                = pd.read_csv("dflongi_impnodel1.csv")
    #df_                = pd.read_csv("dflongi_deal.csv")
    #df_                = pd.read_csv("dflongi_del_deal.csv")
    df_                = pd.read_csv("dflongi_use2.csv")   
    df_["label"]       = df_["outcome"]
    df_["tte"]         = df_["totalTime"]/365
    df_["id"]          = df_["id"]
    df_["times"]       = df_["times"]/365
    bin_list           = ["sex","age","residenc","edu","occ","marriage"]
    cont_list          = []
